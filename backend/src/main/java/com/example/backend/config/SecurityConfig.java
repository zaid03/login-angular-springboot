...
public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests(auth -> auth
            .requestMatchers("/api/register", "/api/login", "/api/validate-usucod", "/api/filter", "/api/mnucods", "/api/ter/**", "/api/more/**", "/api/afa/**", "/api/asu/**", "/api/art/**", "/api/cfg/**", "/api/centrogestor/**").permitAll()
